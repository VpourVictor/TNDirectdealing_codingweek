...
public class FullCalendarView {
    ...
    public void populateCalendar(YearMonth yearMonth) {
        ...
        for (AnchorPaneNode ap : allCalendarDays) {
            ...
            // si calendarDate est dans les dates occupées (réservées) alors on change la couleur de fond
            // ap.changeStyle("-fx-background-color: #FF0000");
            // si dans les dates postulées alors on change la couleur de fond
            // ap.changeStyle("-fx-background-color: #FF0000");
            // si dans les dates de l'annonce mais pas occupées
            // ap.changeStyle("-fx-background-color: #FF0000");
            // else (libre -> rien)
            // ap.changeStyle("-fx-background-color: #FF0000");
