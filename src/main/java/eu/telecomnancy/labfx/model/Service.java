...
public class Service extends Post{
    ...
    public Service(int id, String description, String title, String authorEmail, ArrayList<LocalDate> dates, ArrayList<LocalDate> datesOccupied, Type_Date type_date, Address adress, Image image, State state, String descriptionService, List<Person> providers, List<Integer> applications){
        super(description, title, authorEmail, dates, datesOccupied, type_date, adress, image, state, applications);
        this.descriptionService = descriptionService;
