...
public class Tool extends Post {
    ...
    private Enum<SensTool> sensTool;
    ...
    public Tool (Post post, String stateTool, Enum<SensTool> sensTool) {
        ...
        this.stateTool = stateTool;
        this.sensTool = sensTool;
        Post.id++;
        Post.listId.add(Post.id);
        this.setIdPost(Post.id);
    }

    public Tool(int id, String description, String title, String authorEmail, ArrayList<LocalDate> dates, ArrayList<LocalDate> datesOccupied, Type_Date type_date, Address adress, Image image, State state, String stateTool, List<Integer> applications, Enum<SensTool> sensTool){
        super(description, title, authorEmail, dates, datesOccupied, type_date, adress, image, state, applications);
        this.stateTool = stateTool;
        this.sensTool = sensTool;
        this.setIdPost(id);
    ...
    @Override
    public Enum<SensService> getSensService() {
        return null;
    }
}
