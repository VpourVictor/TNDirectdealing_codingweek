...
public class PostEditController extends HexaSuper {
    ...
    public Label mode;
    @FXML
    private VBox listPost;
    @FXML
    private ToggleGroup toggle_type_date;
    @FXML
    private RadioButton plage;
    @FXML
    private RadioButton ponctuelles;
    @FXML
    private RadioButton seeMyAppliedPosts;
    @FXML
    private RadioButton seeMyPosts;
    @FXML
    private RadioButton sortedByCity;
    @FXML
    private RadioButton sortedByCountry;
    @FXML
    private RadioButton sortedByNote;
    @FXML
    private RadioButton sortedByRegion;
    @FXML
    private RadioButton sortedByStateCurrent;
    @FXML
    private RadioButton sortedByStateEnded;
    @FXML
    private RadioButton sortedByStateFuture;
    @FXML
    private RadioButton sortedByUser;
    @FXML
    private RadioButton onlyServices;
    @FXML
    private RadioButton onlyTools;
    @FXML
    private RadioButton allPost;
    @FXML
    private ToggleGroup choiceLocation;
    @FXML
    private ToggleGroup choiceMyPostedApplied;
    @FXML
    private ToggleGroup choiceOthers;
    @FXML
    private ToggleGroup choicePost;
    @FXML
    private ToggleGroup choiceState;
    @FXML
